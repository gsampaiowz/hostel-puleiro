  ...
  return (
    <div className="max-w-72 mb-8 rounded-lg overflow-visible drop-shadow-[0_0_5px_rgba(0,0,0,1)] relative">
      <div
        ...
        style={{
          transform: `translateX(calc(-${currentSlide * 100}% - 128px))`,
        }}
      >
        {map}
      </div>
      <div className="absolute inset-0 flex items-center justify-between p-2 transition-transform pointer-events-none">
        <button
          onClick={prev}
          className="p-2 rounded-full absolute h-full -left-[1040px] cssBreak:-left-[150px] cssBreak:w-[200px] flex justify-end items-center w-[1000px] pointer-events-auto"
        >
          <FaArrowLeft
            color="white"
            className="bg-black/25 rounded-full size-10 p-2"
          />
        </button>
        <button
          onClick={next}
          className="p-2 rounded-full absolute h-full -right-[1040px] cssBreak:-right-[150px] cssBreak:w-[200px] flex items-center w-[1000px] shadow pointer-events-auto"
        >
          <FaArrowRight
            color="white"
            className="bg-black/25 rounded-full size-10 p-2"
